...
mongoose.connect('mongodb://root:clave@/inventario') // necesitamos un nombre para base de datos, en este caso usamos inentario, se usa mongo por que ese l nombre que le dimos a nuestro contenedor
